    ...
    <div className="bg-white col-span-12 sm:col-span-6 lg:col-span-4 rounded-xl border overflow-hidden m-3">
      ...
      <div className="">
        <div className=" flex gap-1 justify-start flex-row-reverse p-2 ">
          ...
          <h1 className=" font-sans font-medium">شقه سوبر لوكس</h1>
        </div>
        <div className=" flex gap-1 justify-start flex-row-reverse p-2 ">
          <svg
            class="w-6 h-6 text-user font-semibold"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <div className=" flex gap-1 justify-start flex-row-reverse p-2 ">
          ...
          <h1 className=" font-sans text-sm text-gray-500 "> دمياط</h1>
        </div>
        <div className=" flex gap-1 justify-start flex-row-reverse p-2">
          <svg
            class="w-6 h-6 text-gray-800 dark:text-white"
        ...
        <div className=" flex gap-1 justify-start flex-row-reverse p-2 ">
          ...
          <h1 className=" font-sans text-sm text-gray-500 ">(4/0)</h1>
        </div>
      </div>
    </div>
  );
